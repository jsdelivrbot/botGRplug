...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://cdn.jsdelivr.net/gh/AkainuTAMAKI/botGRplug/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        name: "basicBot",
        loggedInID: null,
        scriptLink: "https://cdn.jsdelivr.net/gh/AkainuTAMAKI/botGRplug/basicBot.js",
        cmdLink: "http://git.io/245Ppg",
        chatLink: "https://cdn.jsdelivr.net/gh/AkainuTAMAKI/botGRplug/fr.json",
        chat: null,
        loadChat: loadChat,
        ...
        settings: {
            ...
            motdEnabled: true,
            motdInterval: 5,
            motd: "Bienvenue sur le Plug.dj de la Gaming Room TV (Gaming Room Community - Non Officiel).",
            filterChat: true,
        ...
        eventDjadvance: function (obj) {
            ...
            if (basicBot.settings.songstats) {
                if (typeof basicBot.chat.songstatistics === "undefined") {
                    API.sendChat("/me " + lastplay.media.author + " - " + lastplay.media.title + ": " + lastplay.score.positive + " Woot/ " + lastplay.score.grabs + " Ajout/ " + lastplay.score.negative + " Meh.")
                }
                else {
        ...
        commands: {
            ...
            cookieCommand: {
                ...
                rank: 'user',
                type: 'startsWith',
                cookies: ['vous a donné un cookie au chocolat !',
                    ...
                    'vous offre un biscuit chinois. C\'est écrit "Je t\'aime."',
		    'vous offre un biscuit chinois. C\'est écrit "Va te pendre."',
		    'vous offre un biscuit chinois. C\'est écrit "Vive la GamingRoom TV !"',
		    'vous offre un biscuit chinois. C\'est écrit "Vive les Nanashor !"',
		    'vous offre un biscuit chinois. C\'est écrit "Vive la Geek Band Theory !"',
		    'vous offre un biscuit chinois. C\'est écrit "Vive la CSCorp !"',
		    'vous offre un biscuit chinois. C\'est écrit "Vive la Team Bitchies !"',
                    'vous a offert un cookie en or. Tu ne peux pas le manger parce qu\'il est fait en or. #RT si c\'est triste',
                    'vous a donné un cookie goût Oreo avec un verre de lait!',
		    'vous a donné un cookie aux huîtres ! Beurk ! Qu\'est-ce qu\'il se passe dans ta tête Elvilia ?',
                    'vous a donné un cookie multicolore fait avec amour :heart:',
		    'vous a donné un cookie avec un bol de glaces. C\'est que ça donnerai presque faim !',
		    'vous a donné un cookie à la nougatine et aux noix de pécan. C\'est un délice !',
		    'vous a donné un cookie aux poils ! Furiie serait-elle passée par ici ?',
                    'vous a donné un vieux cookie qui a été laissé sous la pluie, il est totalement moisi.',
                    'vous a préparé un biscuit fraichement sortit du four, quelle générosité.'
                ],
                getCookie: function () {
